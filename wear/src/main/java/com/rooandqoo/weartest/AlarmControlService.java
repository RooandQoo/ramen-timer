 ...
 */
public class AlarmControlService extends IntentService implements GoogleApiClient.ConnectionCallbacks,
    ...
    public AlarmControlService() {
        super(AlarmControlService.class.getSimpleName());
    }
